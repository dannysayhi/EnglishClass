    ...
    public static class SmartCardReader
    {
        ...
        public static void studRCstart(string date, string StudentID, string _getCount, string _type)
        {
            ...
            if (_getCount2 != "")
            {
                ...
                if (AutoCardRollCall(false,StudentID, _getCount2)) //讀卡機自動推撥
                {
        ...
        /// 讀卡機自動推撥
        /// </summary>
        /// <param name="_boolAutoCard"></param>
        /// <param name="studentID"></param>
        /// <param name="getCount"></param>
        /// <returns></returns>
        public static bool AutoCardRollCall(bool _boolAutoCard,string studentID,string getCount)
        {
            try
            {
                string TwName = "";
