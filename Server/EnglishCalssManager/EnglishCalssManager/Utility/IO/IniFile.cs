...
namespace AOISystem.Utility.IO
{
    ...
    public class IniFile
    {
        ...
        public IniFile(string folderPath, string fileName)
        {
            if (folderPath[1] != System.IO.Path.VolumeSeparatorChar)
            {
                _path = string.Format(@"{0}\{1}", System.Windows.Forms.Application.StartupPath, folderPath);
            }
            else
            {
                _path = folderPath;
            ...
            _path = string.Format(@"{0}{1}{2}", _path, fileName, fileName.Contains(".ini") ? string.Empty : ".ini");
        }
        ...
        /// a null reference  (Nothing in VB)
        /// </exception>
        public Int32 GetInt32(string sectionName,
                            string keyName,
                            int defaultValue)
        {
            if (sectionName == null)
        ...
        public Int32 GetInt32(string sectionName, string keyName)
        {
            return GetInt32(sectionName, keyName, 0);
        }
        ...
        public Int64 GetInt64(string sectionName, string keyName)
        {
            return GetInt64(sectionName, keyName, 0);
        }
        ...
        {
            return GetDouble(sectionName, keyName, 0.0);
        }

        public Decimal GetDecimal(string sectionName,
                                string keyName,
                                decimal defaultValue)
        {
            ...
            return Convert.ToDecimal(retval, CultureInfo.InvariantCulture);
        }

        public Decimal GetDecimal(string sectionName, string keyName)
        {
            return GetDecimal(sectionName, keyName, 0);
        }

        public Boolean GetBoolean(string sectionName,
                                string keyName,
                                bool defaultValue)
        {
            string retval = GetString(sectionName, keyName, "");
        ...
        {
            return GetBoolean(sectionName, keyName, false);
        }
        ...
        public int GetInt(string v1, string v2)
        {
        ...
        public void WriteValue(string sectionName, string keyName, long value)
        {
            WriteValue(sectionName, keyName, value.ToString(CultureInfo.InvariantCulture));
        }
        ...
        public void WriteValue(string sectionName, string keyName, decimal value)
        {
            WriteValue(sectionName, keyName, value.ToString(CultureInfo.InvariantCulture));
        }
